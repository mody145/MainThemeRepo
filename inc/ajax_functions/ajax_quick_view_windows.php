	...
	if (isset($_POST['id'])) {
		...
		?>
			...
			<div class="the-content">
				...
				<h3><a href="<?php echo $productInfo->get_permalink() ?>"><?php echo $productInfo->get_title() ?></a></h3>
				...
				<p><?php echo $productInfo->get_short_description() ?></p>

				<p><?php echo $productInfo->get_description() ?></p>
				...
				<p><span class='discount-number'><?php $discount = (($productInfo->get_regular_price() - $productInfo->get_sale_price()) * 100) / $productInfo->get_regular_price(); echo 'This Item Have Discount : ' . floor($discount) . "&nbsp;<i class='icon-percent'></i>"; ?></span></p>
				<?php } else { echo ''; } ?>
				...
				<p><span class="posted_in"><?php echo $productInfo->get_categories() ?></span></p>
				<p><span class="tagged_as"><?php echo $productInfo->get_tags() ?></span></p>
