					...
					<div id="review_form">
						<?php
							...
							$comment_form = array(
								...
								'title_reply_to'       => '<h4><i class="icon-comment-circle"></i>&nbsp; Leave Comment</h4>',
								...
								'label_submit'  => __( 'Send Reviews', 'woocommerce' ),
								'submit_button' 		=> '<div class="submit-button"><input name="%1$s" type="submit" id="%2$s" class="%3$s btn btn-primary" value="Send Reviews" /></div>',
								'logged_in_as'  => '',
								'comment_field' => '',
							);
							...
							$comment_form['comment_field'] .= '<textarea name="comment" class="form-control" rows="5"></textarea>';
